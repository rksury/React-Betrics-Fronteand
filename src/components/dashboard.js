                    ...
                    <div className="col-md-10 content">
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="collapse navbar-collapse menu-hide-mobile navbar-tp-lft">
                                    <ul className="nav navbar-nav navbar-right">
                                        ...
                                        {/*</li>*/}
                                        <li className="bell-icon"><a href="#"><img src="img/bell.png"/>
                                            {/*<span></span>*/}
                                        </a></li>
                                        <li className="user">
                                            <a  className="img-fluid">{}<img src="img/userwhite.png"/></a>
                                            <div className="porfile-div">
                                                <ul>
                                                    <li><a type="submit" onClick={this.logout()}><i
                                                        className="fas fa-sign-out-alt"/> Logout</a>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div className="mobile-view-profile">
                            <div className="left-div">
                                <a href="https://www.google.com"><img src="img/bell.png"/>
                                    {/*<span></span>*/}
                                </a>
                            </div>
                            <div className="right-div">
                                <a href="https://www.google.co" className="img">{this.state.nick_name}<img
                                        ...
                                        <ul className="nav nav-pills main-tab">
                                            <div>
                                                <li className="active matchup-tab">
                                                    <a data-toggle="pill" href="#matchup"/>
                                                </li>
                                            </div>
                                            <div>
                                                <li className="arrow">
                                                    <a data-toggle="pill" href="#news" className="arrow-a"><i
                                        ...
                                        <div id="matchup" className="matchup tab-pane fade in active">
                                            ...
                                            <div className="row">
                                                    ...
                                                    <div className="drop-down-div">
                                                        ...
                                                        <div className="dorpdown-img1 ">
                                                            <div className="dropdown">
                                                                <button className="btn dropdown-toggle" type="button"
                                                                    ...
                                                                    src="img/drop-down-img1.png"/>
                                                                    {this.state.selected_book.name}
                                                                    <span className="fas fa-angle-down arrowRight"/>
                                                                </button>
                                                                <ul className="dropdown-menu">
                                                                    {this.state.book_data.map(book => (
                                                                        <li><a
                                                                            onClick={() => this.updateBook(book.name, book)}>
                                                                            <img
                                                        ...
                                                        <div className="dorpdown-img1 dorpdown-img2">
                                                            <div className="dropdown">
                                                                <button className="btn dropdown-toggle" type="button"
                                                                        data-toggle="dropdown"><img
                                                                    src="img/cal.png"/> {this.state.selected_week.title_verbose}
                                                                    <span className="fas fa-angle-down"/></button>
                                                                <ul className="dropdown-menu">
                                                                    {this.state.weeks_data.map(weeks => (
                                                                        <li><a
                                                                            onClick={() => this.updateWeek(weeks.sequence, weeks)}>{weeks.title_verbose}</a>
                                                                        </li>))}
                                                                </ul>
                                                            </div>
                                                        </div>
                                                                ...
                                                                {odds_data.event.competitors.map(competitor => (
                                                                    ...
                                                                    <tr>
                                                                        <td data-column="Matchup"><img
                                                                            src="img/kanas.png"/><span>{competitor.name}</span>
                                                                        </td>
                                                            ...
                                                            <div className="time-button-div">
                                                                <div className="row">
                                                                    <div className="col-md-6 col-sm-6  text">
                                                                        <p>
                                                                            <span>{new Date(Date.parse(odds_data.event.scheduled)).toDateString()}</span>
                                                                        </p>
                                                                    </div>
                                                ...
                                                <div className="col-md-5 table-resposiv">
                                                    ...
                                                    {/*                    type="button"*/}
                                                    {/*                    data-toggle="dropdown">{this.state.selected_book.name}*/}
                                                    {/*                <span className="fas fa-angle-down arrowRight"/>*/}
                                                    {/*            </button>*/}
                                                    {/*            <ul className="dropdown-menu">*/}
                                                    {/*                {this.state.book_data.map(book => (*/}
                                                    {/*                    <li><a*/}
                                                    {/*                        onClick={() => this.updateBook(book.name, book)}>{book.name}*/}
                                                    {/*                    </a></li>*/}
                                                    {/*                ))}*/}
                                                    {/*            </ul>*/}
                                                    {/*        </div>*/}
                                                    ...
                                                    {/*            <button className="btn dropdown-toggle"*/}
                                                    {/*                    type="button"*/}
                                                    {/*                    data-toggle="dropdown">{this.state.selected_week.title_verbose}*/}
                                                    {/*                <span className="fas fa-angle-down"/></button>*/}
                                                    {/*            <ul className="dropdown-menu">*/}
                                                    {/*                {this.state.weeks_data.map(weeks => (*/}
                                                    {/*                    <li><a*/}
                                                    ...
                                                    <div className="right-drop-down">
                                                        <div className="drop-down-div">
                                                            ...
                                                            <div className="filter-option">
                                                                <a><i className=" fas fa-sliders-h"/></a>
                                                            </div>
                                                            <div className="clearfix"/>
                                                        </div>
                                                    </div>
                                                    {this.state.odds_data.map(odds_data => (
                                                        ...
                                                        <table>
                                                            ...
                                                            <tbody>
                                                            <tr>
                                                                <td data-column="Pred Score"><span
                                                                    className="predScoreText">22.0</span></td>
